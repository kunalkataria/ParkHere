...
public class ParkingSpotDetailsActivity extends AppCompatActivity {
    ...
    @BindView(R.id.parking_spot_name)
    TextView parkingSpotNameTextView;
    ...
    @BindView(R.id.listing_details_toolbar)
    Toolbar postListingToolbar;
    @BindView(R.id.edit_listing_button)
    AppCompatButton editListingButton;
...
//            providerNameTextView.setVisibility(View.GONE);
        ...
        parkingSpotNameTextView.setText(listingResult.getName());
        Picasso.with(this).load(listingResult.getImageURL()).into(parkingImageView);
        parkingSpotDetailsHandicapTextView.setText("Handicap? " + listingResult.isHandicap());
        parkingSpotDetailsCoveredTextView.setText("Covered? " + listingResult.isCovered());
        parkingSpotDetailsCompactTextView.setText("Compact? " + listingResult.isCompact());
    ...
    protected void bookListing() {
        Intent intent = new Intent(ParkingSpotDetailsActivity.this, TransactionActivity.class);
    ...
    protected void displayProvider() {
        ...
        Intent intent = new Intent(ParkingSpotDetailsActivity.this, UserProfileActivity.class);
        Bundle bundle = new Bundle();
